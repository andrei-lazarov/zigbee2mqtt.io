...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs), effect, power_on_behavior, action, action_group, action_level, action_step_size, action_transition_time, action_rate |
