...
| Exposes | device_temperature, identify, switch (state), power, voltage, current, energy, action, action_group, action_level, action_step_size, action_transition_time, action_rate |
