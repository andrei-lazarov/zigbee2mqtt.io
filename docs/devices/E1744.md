...
press = 1s, Toggle
2 press = 1s, Step (Up, size 1, t=0)
3 press = 0.8s, Step (Down, size 1, t=0)
4+ press = nothing
long-press = nothing
rotate CW = Move (Up 195) + Stop
rotate CCW = Move (Down 195) + Stop

old fw: simultaneously bind to groups (basic) and devices (any, only one)
new fw: groups (basic) or devices (any)
