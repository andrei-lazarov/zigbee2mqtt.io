...
| Exposes | switch (state), power_on_behavior, switch_actions, switch_type, operation_mode, scene_id, group_id, min_level, max_level, action, action_group, action_level, action_step_size, action_transition_time, action_rate |
