...
| Exposes | light (state, brightness), effect, power_on_behavior, power, voltage, current, energy, wifi_status, ip_address, dhcp_enabled, wifi_config, action, action_group, action_level, action_step_size, action_transition_time, action_rate |
