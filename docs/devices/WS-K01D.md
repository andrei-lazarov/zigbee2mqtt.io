...
| Exposes | switch (state), device_temperature, power_outage_count, power_outage_memory, operation_mode, energy, voltage, current, power, led_disabled_night, flip_indicator_light, action, action_group |
